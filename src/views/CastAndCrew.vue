...
<template>
  ...
  <div class="container-fluid cast-crew-view bg-body-secondary"
      ...
      <div v-else >
        ...
        ">
          <div class="section-content ">
            ...
            <div id="collapse-actors-section"
              ...
              <div class="card-container">
                ...
                >
                  ...
                  <div class="card-body p-2">
                    <p class="card-text fw-bolder small mb-0">{{
                        member.name
                      }}</p>
                    <span class="cart-post small mt-1" style="color: #032541;">{{
                        member.character
                      }}</span>
                  </div>
                </div>
        ...
        <div class="d-flex justify-content-center">
          <div class="section-content">
            <h4 class="section-title fw-bold justify-content-start p-3">Equipe
              technique
              <span
                  class="section-longerTechnicalTeams fs-4 fw-light text-secondary">
            ...
            <div id="collapse-art-section" class="collapse collapse-vertical">
              <div class="card-container ">
                <div
            ...
            <div id="collapse-camera-section"
                 class="collapse collapse-vertical">
              <div class="card-container ">
                <div
                ...
                >
                  ...
                  <div class="card-body p-2">
                    ...
                    <span class="cart-post small mt-1"
                          style="color:#032541">{{ crew.job }}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div id="collapse-costume-section"
                 class="collapse collapse-vertical">
              <div class="card-container ">
            ...
            <div id="collapse-equipe-technique-section"
                 class="collapse collapse-vertical">
              <div class="card-container ">
                <div
            ...
            <div id="collapse-directing-section"
                 class="collapse collapse-vertical">
              <div class="card-container ">
                <div
            ...
            <div id="collapse-editing-section"
                 class="collapse collapse-vertical">
              <div class="card-container ">
            ...
            <div id="collapse-light-section" class="collapse collapse-vertical">
              <div class="card-container ">
            ...
            <div id="collapse-production-section"
                 class="collapse collapse-vertical">
              <div class="card-container ">
                <div
            ...
            <div id="collapse-sound-section" class="collapse collapse-vertical">
              <div class="card-container">
                <div
            ...
            <div id="collapse-effectVisuel-section"
                 class="collapse collapse-vertical">
              <div class="card-container">
                <div
            ...
            <div id="collapse-writing-section"
                 class="collapse collapse-vertical">
              <div class="card-container">
