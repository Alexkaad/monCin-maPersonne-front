...
const navigateToSingle = (event :Event ) => {
  console.log('ID du film:', props.id);
...
<template>
  ...
  <div class="container carte-film-style-1">
    <div class="card border-1 border-emphasis card-fixed-size">
      ...
      <div class="img-container position-relative" @click="navigateToSingle($event)">
      ...
      <div class="card-body d-flex flex-column">
        <h6 class="card-title-bottom fw-bold" style="color
        :#374558;">{{
